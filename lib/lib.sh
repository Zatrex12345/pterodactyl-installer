...
# download URLs
export PANEL_DL_URL="https://github.com/Jexactyl/Jexactyl/releases/download/v3.7.3/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/Zatrex12345/pterodactyl-installer"}
